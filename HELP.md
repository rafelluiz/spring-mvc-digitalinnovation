...
* The original package name 'zup.spring.mvc.spring-mvc-digitalinnovation' is invalid and this project uses 'zup.spring.mvc.springmvcdigitalinnovation' instead.
